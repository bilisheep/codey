...
The TypeScript SDK wraps the `codex` CLI from `@bilisheep/codey`. It spawns the CLI and exchanges JSONL events over stdin/stdout.

## Installation

```bash
npm install @bilisheep/codey-sdk
```
...
```typescript
import { Codex } from "@bilisheep/codey-sdk";
